...
public class Converter {
	...
	public enum Temperature {
		CELSIUM(0, "Celsium"), KELVIN(1, "Kelvin"), FAHRENHEIT(2, "Fahrenheit"), RANKIN(
				3, "Rankin"), DELISLE(4, "Delisle"), NEWTON(5, "Newton"), REAMUR(
				6, "Reamur"), ROMER(7, "Romer");
	...
	public static void Convert(Temperature from, Temperature to, double temp) {
		...
		LOG.info("From " + temp + " " + from.name + " to " + result + " "
				+ to.name);
	}
}
/*
 ...
 * log4j.appender.file.Encoding=Cp1251 log4j.appender.file.file =
 * ./logs/test.log log4j.appender.file.layout=org.apache.log4j.PatternLayout
 ...
 * log4j.appender.console.layout.ConversionPattern=%-5p: %d{dd.MM.yyyy HH:mm}
 * %m%n
 */